...
<body>
	...
	<h1><span class="glyphicon glyphicon-tag"></span> 상품 / 추가하기  </h1></div><br>
...
<div align="center">
    <button type="submit" name="submit" id="submit" class="btn btn-default" style="width:100px; height:60px"> 취소</button>
    <button type="submit" name="submit" id="submit" class="btn btn-success" style="width:150px; height:60px"> 상품 추가</button>
    </div>
        </form>
