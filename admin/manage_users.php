...
/*this is delet quer*/
mysqli_query($con,"delete from user_info where user_id='$user_id'")or die("쿼리 잘못 되었습니다.");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<?php 
$result=mysqli_query($con,"select user_id, email, password from user_info")or die ("2번째 쿼리 잘못되었습니다.");
...
<a href='manage_users.php?user_id=$user_id&action=delete'>삭제</a>
</td></tr>";
}
mysqli_close($con);
?>
